...
## OUTPUT:
![image](https://github.com/user-attachments/assets/662c7c08-dec4-44cf-9f7b-2bb826d3f07c)


## RESULT:
The host took 0.088581 seconds to complete it’s computation, while the GPU outperforms the host and completes the computation in 0.05995 seconds. Therefore, float variables in the GPU will result in the best possible result. Thus, matrix summation using 2D grids and 2D blocks has been performed successfully.
